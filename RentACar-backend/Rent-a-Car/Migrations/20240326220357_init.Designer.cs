...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentACar.DBContext.AutentifikacijaToken", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.DBContext.KorisnickiNalog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.DBContext.Recensions", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RecensionsId"), 1L, 1);
            ...
            modelBuilder.Entity("RentACar.DBContext.Korisnik", b =>
                {
                    b.HasBaseType("RentACar.DBContext.KorisnickiNalog");
            ...
            modelBuilder.Entity("RentACar.DBContext.AutentifikacijaToken", b =>
                {
                    b.HasOne("RentACar.DBContext.KorisnickiNalog", "korisnickiNalog")
                        .WithMany()
            ...
            modelBuilder.Entity("RentACar.DBContext.Korisnik", b =>
                {
                    b.HasOne("RentACar.DBContext.KorisnickiNalog", null)
                        .WithOne()
                        .HasForeignKey("RentACar.DBContext.Korisnik", "ID")
