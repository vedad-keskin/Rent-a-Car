    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(1998, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Vedad", "111111111", "Keskin" });

            migrationBuilder.InsertData(
                table: "Person",
                columns: new[] { "PersonId", "BirthDate", "FirstName", "JMBG", "LastName" },
                values: new object[] { 2, new DateTime(2001, 2, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Said", "111111111", "Keskin" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Email", "Password", "PersonId", "UserName" },
                values: new object[] { 1, "vedad.keskin98@gmail.ba", "bayern123", 1, "vedadke" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Email", "Password", "PersonId", "UserName" },
                values: new object[] { 2, "vedad.keskin98@gmail.ba", "bayern123", 2, "saidke" });
