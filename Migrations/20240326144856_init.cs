        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Registred = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsFeed", x => x.NewsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecensionsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recensions", x => x.RecensionsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Installments = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactinId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.TransactinId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CarDetails_Country_CountryOfManufactureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentDate", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RentDate_Car_CarID",
                        column: x => x.CarID,
                        principalTable: "Car",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RentDate_Rent_RentID",
                        column: x => x.RentID,
                        principalTable: "Rent",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Person",
                columns: new[] { "PersonId", "BirthDate", "FirstName", "JMBG", "LastName" },
                values: new object[,]
                {
                    { 1, new DateTime(1998, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Vedad", "111111111", "Keskin" },
                    { 2, new DateTime(2001, 2, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Said", "111111111", "Keskin" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Email", "Password", "PersonId", "UserName" },
                values: new object[,]
                {
                    { 1, "vedad.keskin@edu.fit.ba", "bayern123", 1, "vedadke" },
                    { 2, "said.keskin@edu.fit.ba", "bayern123", 2, "saidke" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDetails_CountryOfManufactureId",
                table: "CarDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentDate_CarID",
                table: "RentDate",
                column: "CarID");

            migrationBuilder.CreateIndex(
                name: "IX_RentDate_RentID",
                table: "RentDate",
                column: "RentID");
